...
# 🚀 MUDANÇA AQUI: Trocamos "centered" por "wide" para ativar a tela cheia!
st.set_page_config(page_title="Studio Jeh Beauté", page_icon="💇‍♀️", layout="wide")

# --- DESIGN CORRIGIDO PARA TELA CHEIA (CSS) ---
VISUAL_STUDIO = """
    <style>
    /* Força o fundo do site inteiro a ser o Pérola/Off-white aconchegante da paleta */
    .stApp, [data-testid="stAppViewContainer"], .block-container {
        background-color: #FAF6F0 !important; 
        background-image: none !important;
    }

    /* Ajusta o espaçamento interno agora que a tela está cheia */
    .block-container {
...
# Organizando os campos lado a lado de forma bem distribuída na tela cheia
...
# --- BOTÃO "AGENDAR AGORA" CENTRALIZADO NA TELA CHEIA ---
botao_html = f"""
